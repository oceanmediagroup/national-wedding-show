...
<!-- footer -->
<footer class="footer top-accent top-accent--white">
            ...
            <div class="col-lg-3 col-sm-6 footer__follow-us">
                ...
                <a href="https://www.instagram.com/thenationalweddingshow/" target="blank"
                    class="header-menu__link--img"><img data-src="/assets/img/1.png"
                        alt="The National Wedding Show Instagram" class="lazy"></a>
                <a href="https://www.facebook.com/nationalweddingshow" target="blank" class="header-menu__link--img">
                    <img data-src="/assets/img/2.png" alt="The National Wedding Show Facebook" class="lazy"></a>
            </div>
            <div class="col-lg-3 col-sm-6">
                <a href="https://exhibitor.nationalweddingshow.co.uk/login" target="blank"
                    class="button--new-primary-dark ex-button">EXHIBITOR LOGIN</a>
            </div>
        </div>
    </div>
...
<script src="/assets/script/app.js?t=1594817034521"></script>
    ...
    $(document).on("click", '[data-toggle="lightbox"]', function (event) {
        ...
        $(this).ekkoLightbox({
            ...
            onShow: function () {
                ...
                $('.ekko-lightbox').find('.close').find('span').html(
                    '<img src="https://nationalweddingshow.co.uk/assets/img/close.png" />');
            },
        });
    });
</script>
