...
class headerMenuWalker extends Walker_Nav_Menu
{
    ...
    public function start_lvl( &$output, $depth = 0, $args = array() ) {
        ...
        $output .= "\n$indent<div class=\"dropdown-menu\"><div class=\"container\"><div class=\"row dropdown-menu__wrapper\">\n";
    }
    /**
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $classes[] = 'header__item-' . $item->ID;

        if ($item->title === "Home") {
            $classes[] .= 'header__item--big';
        } else {
            $classes[] .= 'header__item--small';
        }
        ...
        */
        ...
        if ($depth > 0) {
            $item_output .= $args->link_before . '<img src="' . get_the_post_thumbnail_url($item->object_id) . '" alt="' . apply_filters('the_title', $item->title, $item->ID) . '" class="dropdown-item-image">'
                . '<span>' . apply_filters('the_title', $item->title, $item->ID) . '</span>' . $args->link_after;
