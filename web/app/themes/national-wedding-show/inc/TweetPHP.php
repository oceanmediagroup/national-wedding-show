 ...
 class TweetPHP {
     ...
     public function  __construct ($options = array()) {
         ...
         $this->options = array_merge(
             array(
                 'consumer_key'          => 'GklGwkvrD5NvGb2wjpsyVWDSg',
                 'consumer_secret'       => 'rVcNnGVX5jtXo4u1X2SBNOqhyluepeoqX0G9uc2wup2sfZbYhu',
                 'access_token'          => '43294027-NBjWIAr8FIujUBHEMt1AkfRM1dSVOidolUuzYsG3c',
                 'access_token_secret'   => 'qmJrVYau7OA6fXgZGkAkWRYtRGLhjDY2Vbriih7yLJc0C',
                 ...
                 'twitter_date_text'     => array(),
                 'date_format'           => '%I:%M ', // The defult date format e.g. 12:08 PM Jun 12th. See: http://php.net/manual/en/function.strftime.php
