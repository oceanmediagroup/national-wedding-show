    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6 page-locations-desc__text-wrapper">
                <div class="row">
                    <div class="col-12">
                        <h2 class="page-locations-desc__title"><span class="t-underline-powder--alpha"><?php the_field('loc-esen-title'); ?></span></h2>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <a href="<?php echo $button['external_link_checkbox'] ? $button['cta_link_external'] : $button['cta_link_internal']; ?>"
                           class="col-12 col-md-5 page-locations-desc__button-link button--light-rose">
