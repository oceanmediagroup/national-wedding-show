    ...
    <div class="container">
        <div class="row">
            <div class="col instagram__header-col text-center">
                <h2 class="instagram__title t-section-heading "><span class="t-underline-coral--alpha">Follow
                        us</span>
                </h2>
        ...
        <div class="row instagram__feed-row">
            <div class="col-md-4"><img class="w-100" src="https://via.placeholder.com/300" alt=""></div>
            <div class="col-md-4"><img class="w-100" src="https://via.placeholder.com/300" alt=""></div>
            <div class="col-md-4"><img class="w-100" src="https://via.placeholder.com/300" alt=""></div>
