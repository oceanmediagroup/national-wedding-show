<section class="inspiration-section">
    ...
    <div class="container">
        ...
        <div class=" card-deck owl-carousel owl-theme owl-inpiration-cards">
            <div class="item card">
                ...
                <a href="<?php echo get_the_permalink() ?>">
                    <div class="image-wrapper lazy" data-bg="url(<?php echo get_the_post_thumbnail_url(); ?>)">
                    </div>
                    <div class="card-body">
            ...
            <div class="item card">
                ...
                <div data-url="/?type=tutorial&id=tutorial-<?php echo get_the_ID() ?>" data-toggle="modal"
                    ...
                    <div class="image-wrapper tutorial">
                        <iframe id="ytplayer" type="text/html" width="640" height="360" class="lazy"
                            data-src="<?php echo get_field('tutorial_video_link'); ?>" frameborder="0"
                            class="card-img-top" allowfullscreen="allowfullscreen"
        ...
        if ($the_query->have_posts()) {
            while ($the_query->have_posts()) {
                $the_query->the_post(); ?>
        <div class="modal fade tutorial-modal" id="tutorial-<?php echo get_the_ID() ?>" tabindex="-1" role="dialog"
            aria-labelledby="tutorial-<?php echo get_the_ID() ?>Label" aria-hidden="true">
                ...
                <div class="modal-content tutorial-modal__content">
                    ...
                    <div class="modal-body">
                        <iframe id="ytplayer" type="text/html" width="640" height="360"
                            src="<?php echo get_field('tutorial_video_link'); ?>" frameborder="0"
                            class="tutorial-modal__video" allowfullscreen="allowfullscreen"
                            mozallowfullscreen="mozallowfullscreen" msallowfullscreen="msallowfullscreen"
                            oallowfullscreen="oallowfullscreen" webkitallowfullscreen="webkitallowfullscreen"></iframe>
