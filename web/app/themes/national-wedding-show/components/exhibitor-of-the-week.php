            ...
            <div class="row h-100">
                <div class="col-12 col-md">
                    <div class="exhibitor__image-wrapper">
                        ...
                        <div class="exhibitor__accent-text"><?php echo get_field('exhibitor_accent_text') ?></div>
                    </div>
                </div>
                <div class="col-12 col-md align-self-center">
                    <div class="exhibitor__content">
                        <h3 class="exhibitor__title">
                            <?php echo get_field('exhibitor_title') ?>
                        </h3>
                        <span class="exhibitor__text">
                        ...
                        <a href="<?php echo $button['external_link_checkbox'] ? $button['cta_link_external'] : $button['cta_link_internal']; ?>"
                           class="button--light-coral button--light-solid exhibitor__link"
