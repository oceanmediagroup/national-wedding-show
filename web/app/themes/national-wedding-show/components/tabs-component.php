                        ...
                        <?php while (have_rows('tabs_repeater')): the_row();
                            ...
                            <li class="nav-item" style="width: calc(100% / <?php echo $count_rows; ?>);">
                                <a class="nav-link <?php if ($counter1 == 0) echo 'active'; ?>"
                                   id="<?php echo str_replace(' ', '', $name); ?>-tab"
                                   data-toggle="tab"
                                   href="#tab<?php echo $counter1; ?>"
                                   role="tab"
                                   aria-controls="<?php echo str_replace(' ', '', $name); ?>"
                                   aria-selected="<?php if ($counter1 == 0) {
                                       echo 'true';
                                   } else {
                                       echo 'false';
                                   } ?>">
