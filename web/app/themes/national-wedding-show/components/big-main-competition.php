<section class="big-main-competition">
    <div class="container-fluid">
        <div class="row big-main-competition__wrapper lazy"
                    ...
                    <div class="col-md-8 offset-md-2">
                        <div class="competition">
                            <div class="competition-card-big__content">
                                ...
                                <h3 class="competition-card-big__title"><?php echo get_field('competition_name'); ?>
                                </h3>
                                <span
                                    class="competition-card-big__text"><?php echo get_field('competition_text'); ?></span>
