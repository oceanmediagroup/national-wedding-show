...
<div class="header-carousel-simple color-overlay-wrapper">
    <div class="owl-carousel owl-theme owl-header-simple ">
        ...
        <div class="image item lazy" data-bg="url('<?php echo get_sub_field('background_image')['url'] ?>')"></div>
        <?php endif; ?>
        ...
        <div class="video item custom-video video-container color-overlay-wrapper lazy"
            ...
            <div class="video-wrapper">
                ...
                <iframe width="560" height="315" class="lazy"
                    data-src="<?php echo get_sub_field('video_link') ?>?background=1" webkitallowfullscreen
                    mozallowfullscreen allowfullscree></iframe>
                <?php endif; ?>
            </div>
